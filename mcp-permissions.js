        ...
        serialize: function serialize2(wsComponents, options) {
          ...
          if (wsComponents.resourceName) {
            var _wsComponents$resourc = wsComponents.resourceName.split("?"),
              ...
              path2 = _wsComponents$resourc2[0],
      ...
      switch (dataType) {
        ...
        case "integer":
          return (
            ...
            EQUAL +
            data +
            (strictNumbers ? AND + OK2 + "isFinite(" + data + ")" : "") +
            ")"
          );
        case "number":
          return (
...
var require_resolve = __commonJS({
  "node_modules/ajv/lib/compile/resolve.js"(exports2, module2) {
    ...
    var PREVENT_SCOPE_CHANGE = util2.toHash([
      "properties",
      "patternProperties",
      "enum",
      "dependencies",
  ...
  "node_modules/ajv/lib/compile/index.js"(exports2, module2) {
    ...
    function patternCode(i, patterns) {
      return (
        ...
        i +
        " = new RegExp(" +
        util2.toQuotedString(patterns[i]) +
        ");"
      );
    }
...
var ProgressTokenSchema = external_exports.union([
  external_exports.string(),
  external_exports.number().int(),
]);
var CursorSchema = external_exports.string();
var RequestMetaSchema = external_exports
  .object({
    /**
  ...
  .passthrough();
var BaseRequestParamsSchema = external_exports
  .object({
...
var BaseNotificationParamsSchema = external_exports
  .object({
    /**
...
var ResultSchema = external_exports
  .object({
    /**
     * See [MCP specification](https://github.com/modelcontextprotocol/modelcontextprotocol/blob/47339c03c143bb4ec01a26e721a1b8fe66634ebe/docs/specification/draft/basic/index.mdx#general-fields)
     * for notes on _meta usage.
  ...
  .passthrough();
var RequestIdSchema = external_exports.union([
  external_exports.string(),
  external_exports.number().int(),
]);
...
var BaseMetadataSchema = external_exports
  .object({
...
var ClientCapabilitiesSchema = external_exports
  .object({
    /**
     * Experimental, non-standard capabilities that the client supports.
     */
    experimental: external_exports.optional(
      external_exports.object({}).passthrough(),
    ),
    /**
     * Present if the client supports sampling from an LLM.
     */
    sampling: external_exports.optional(
      external_exports.object({}).passthrough(),
    ),
    /**
     * Present if the client supports eliciting user input.
     */
    elicitation: external_exports.optional(
      external_exports.object({}).passthrough(),
    ),
    /**
     * Present if the client supports listing roots.
     */
    roots: external_exports.optional(
      external_exports
        .object({
          /**
...
var ServerCapabilitiesSchema = external_exports
  .object({
    /**
     ...
     */
    logging: external_exports.optional(
      external_exports.object({}).passthrough(),
    ),
    /**
     * Present if the server supports sending completions to the client.
     */
    completions: external_exports.optional(
      external_exports.object({}).passthrough(),
    ),
    /**
...
var ProgressSchema = external_exports
  .object({
    /**
...
var ReadResourceResultSchema = ResultSchema.extend({
  contents: external_exports.array(
...
var PromptArgumentSchema = external_exports
  .object({
    /**
...
var PromptSchema = BaseMetadataSchema.extend({
   ...
   */
  arguments: external_exports.optional(
    external_exports.array(PromptArgumentSchema),
  ),
  /**
   * See [MCP specification](https://github.com/modelcontextprotocol/modelcontextprotocol/blob/47339c03c143bb4ec01a26e721a1b8fe66634ebe/docs/specification/draft/basic/index.mdx#general-fields)
   * for notes on _meta usage.
...
var ImageContentSchema = external_exports
  ...
  .passthrough();
var AudioContentSchema = external_exports
  .object({
...
var PromptMessageSchema = external_exports
  .object({
...
var ToolAnnotationsSchema = external_exports
  .object({
    /**
...
var ToolSchema = BaseMetadataSchema.extend({
  ...
  inputSchema: external_exports
    .object({
      ...
      required: external_exports.optional(
   ...
   */
  outputSchema: external_exports.optional(
    external_exports
      .object({
        type: external_exports.literal("object"),
        properties: external_exports.optional(
...
var ModelHintSchema = external_exports
  .object({
    /**
  ...
  .passthrough();
var ModelPreferencesSchema = external_exports
  .object({
    /**
     ...
     */
    costPriority: external_exports.optional(
      external_exports.number().min(0).max(1),
    ),
    /**
     * How much to prioritize sampling speed (latency) when selecting a model.
     */
    speedPriority: external_exports.optional(
      external_exports.number().min(0).max(1),
    ),
    /**
     * How much to prioritize intelligence and capabilities when selecting a model.
     */
    intelligencePriority: external_exports.optional(
      external_exports.number().min(0).max(1),
    ),
  })
  .passthrough();
var SamplingMessageSchema = external_exports
  .object({
    role: external_exports.enum(["user", "assistant"]),
...
var CreateMessageRequestSchema = RequestSchema.extend({
  ...
  params: BaseRequestParamsSchema.extend({
     ...
     */
    includeContext: external_exports.optional(
      external_exports.enum(["none", "thisServer", "allServers"]),
    ),
    ...
    stopSequences: external_exports.optional(
      external_exports.array(external_exports.string()),
    ),
    /**
     * Optional metadata to pass through to the LLM provider. The format of this metadata is provider-specific.
     */
    metadata: external_exports.optional(
      external_exports.object({}).passthrough(),
    ),
    /**
...
var CreateMessageResultSchema = ResultSchema.extend({
   ...
   */
  stopReason: external_exports.optional(
    external_exports
...
var BooleanSchemaSchema = external_exports
  .object({
  ...
  .passthrough();
var StringSchemaSchema = external_exports
  .object({
    ...
    format: external_exports.optional(
      external_exports.enum(["email", "uri", "date", "date-time"]),
    ),
  })
  .passthrough();
var NumberSchemaSchema = external_exports
  .object({
  ...
  .passthrough();
var EnumSchemaSchema = external_exports
  .object({
    type: external_exports.literal("string"),
    title: external_exports.optional(external_exports.string()),
    description: external_exports.optional(external_exports.string()),
    enum: external_exports.array(external_exports.string()),
    enumNames: external_exports.optional(
      external_exports.array(external_exports.string()),
    ),
  })
  .passthrough();
...
var ElicitRequestSchema = RequestSchema.extend({
  ...
  params: BaseRequestParamsSchema.extend({
     ...
     */
    requestedSchema: external_exports
      .object({
        type: external_exports.literal("object"),
...
var ElicitResultSchema = ResultSchema.extend({
   ...
   */
  content: external_exports.optional(
...
var ResourceTemplateReferenceSchema = external_exports
  .object({
  ...
  .passthrough();
var PromptReferenceSchema = external_exports
  .object({
...
var CompleteRequestSchema = RequestSchema.extend({
  ...
  params: BaseRequestParamsSchema.extend({
    ...
    argument: external_exports
      ...
      .passthrough(),
    context: external_exports.optional(
...
var RootSchema = external_exports
  .object({
    /**
...
var Protocol = class {
  ...
  async connect(transport) {
    ...
    const _onclose =
      (_a = this.transport) === null || _a === void 0 ? void 0 : _a.onclose;
    this._transport.onclose = () => {
      _onclose === null || _onclose === void 0 ? void 0 : _onclose();
      this._onclose();
    };
    const _onerror =
      (_b = this.transport) === null || _b === void 0 ? void 0 : _b.onerror;
    this._transport.onerror = (error) => {
      _onerror === null || _onerror === void 0 ? void 0 : _onerror(error);
      this._onerror(error);
    };
    const _onmessage =
      (_c = this._transport) === null || _c === void 0 ? void 0 : _c.onmessage;
    this._transport.onmessage = (message, extra) => {
      _onmessage === null || _onmessage === void 0
        ? void 0
  ...
  _onrequest(request, extra) {
    ...
    const fullExtra = {
      ...
      requestInfo:
        extra === null || extra === void 0 ? void 0 : extra.requestInfo,
    };
    Promise.resolve()
    ...
    return new Promise((resolve, reject) => {
      ...
      if (
        ...
        jsonrpcRequest.params = {
          ...request.params,
          _meta: {
            ...(((_c = request.params) === null || _c === void 0
              ? void 0
              : _c._meta) || {}),
      ...
      this._setupTimeout(
        ...
        (_f =
          options === null || options === void 0
            ? void 0
            : options.resetTimeoutOnProgress) !== null && _f !== void 0
          ? _f
          : false,
      );
      this._transport
...
var Server = class extends Protocol {
  ...
  assertCapabilityForMethod(method) {
    ...
    switch (method) {
      ...
      case "roots/list":
        if (
          !((_c = this._clientCapabilities) === null || _c === void 0
            ? void 0
            : _c.roots)
        ) {
          throw new Error(
...
var McpServer = class {
  ...
  _createRegisteredPrompt(name, title, description, argsSchema, callback) {
    const registeredPrompt = {
      ...
      description,
      argsSchema:
        argsSchema === void 0 ? void 0 : external_exports.object(argsSchema),
      callback,
      enabled: true,
      ...
      update: (updates) => {
        ...
        if (typeof updates.argsSchema !== "undefined")
          registeredPrompt.argsSchema = external_exports.object(
            updates.argsSchema,
          );
        if (typeof updates.callback !== "undefined")
  ...
  _createRegisteredTool(
    ...
    const registeredTool = {
      ...
      description,
      inputSchema:
        inputSchema === void 0 ? void 0 : external_exports.object(inputSchema),
      outputSchema:
        outputSchema === void 0
          ? void 0
          : external_exports.object(outputSchema),
      annotations,
      callback,
      enabled: true,
      ...
      update: (updates) => {
        ...
        if (typeof updates.paramsSchema !== "undefined")
          registeredTool.inputSchema = external_exports.object(
            updates.paramsSchema,
          );
        if (typeof updates.callback !== "undefined")
  ...
  try {
    ...
    return new Promise((resolve) => {
      ...
      const watcher = fs.watch(PERMISSIONS_PATH, (eventType, filename) => {
        if (
          eventType === "rename" &&
          filename === path.basename(responseFile)
        ) {
    ...
    return {
      approved: false,
      reason: `Error processing permission request: ${error}`,
    };
  }
}
server.tool(
